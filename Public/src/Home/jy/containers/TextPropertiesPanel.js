...
import { setTextColorActiveIndex, addTextColor, setTextColorPanelVisible,
         setTextStrokeActiveIndex, addTextStroke, setTextStrokePanelVisible } from '../actions';
...
class TextPropertiesPanel extends Component {
  ...
  renderStrokePanel() {
    let currentTextStrokeColorString = this.props.activeStrokeColorIndex >= 0 ? this.props.strokeColorItems[this.props.activeStrokeColorIndex] : '#fff';
